...
class LinesFactura(models.Model):
	...
	costo=fields.Float(related='product_id.standard_price',store=True,readonly=True)
	precio=fields.Float(related='product_id.lst_price',store=True,readonly=True)
