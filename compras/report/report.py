...
class MovimientosXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, account):
        ...
        for obj in account:
            ...
            sheet.write(i, 6, obj.amount_untaxed if(obj.tipo=='1') else 0, money)
            sheet.write(i, 7, obj.amount_untaxed if(obj.tipo=='2') else 0, money)
            sheet.write(i, 8, obj.amount_untaxed if(obj.tipo=='3') else 0, money)
            ...
            sheet.write(i, 14, obj.amount_total, money)
