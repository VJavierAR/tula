...
class ParseXML(models.TransientModel):
    ...
    def search_data(self, table, data, field='name', company=False, tax=False):
        """
        ...
        if tax:
            query += " and type_tax_use='purchase'"
        query += " limit 1;"
        ...
        if True: #try:
            ...
            for l in root.findall('DetalleServicio')[0].findall('LineaDetalle'):
                ...
                if impuesto is not None:
                    ...
                    codigo_impuesto = self.search_data('account_tax', str(tarifa_impuesto), 'name', company_id, True)
                    if codigo_impuesto:
                ...
                if descuento is not None:
                    ...
                    if False: #desc > 0.00:
                        ...
                        linea.update({'discount': round((desc / monto_total),2) * 100})
                else:
