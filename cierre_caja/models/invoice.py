    ...
    def get_ventas(self):
        ...
        for li in lines:
            ...
            for liin in li.invoice_line_ids:
                descuento=descuento+((liin.price_unit*li.quantity)-(liin.price_subtotal*li.quantity))
        ...
        for li in lines2:
            ...
            for liin in li.invoice_line_ids:
                descuento2=descuento2+((liin.price_unit*li.quantity)-(liin.price_subtotal*li.quantity))
